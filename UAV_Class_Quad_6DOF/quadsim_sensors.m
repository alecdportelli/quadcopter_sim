...
function out = quadsim_sensors(uu, P)
    ...
    static_press = true_static_press + bias_static_press + P.sigma_noise_static_press*randn;
    ...
    diff_press = true_diff_press + bias_diff_press + P.sigma_noise_diff_press*randn; 
